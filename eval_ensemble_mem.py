...
import eval_utils_mem_ensemble
import argparse
...
model_infos_path = ['id60/infos_id600070.pkl','id64/infos_id640068.pkl','id67/infos_id670068.pkl']
model_paths = ['id60/modelid600070.pth','id64/modelid640068.pth','id67/modelid670068.pth']
memory_paths = ['id60/memory_cellid600070.npz','id64/memory_cellid640068.npz','id67/memory_cellid670068.npz']

# model_infos_path = ['id64/infos_id640040.pkl']
# model_paths = ['id64/modelid640040.pth']
# memory_paths = ['id64/memory_cellid640040.npz']
...
# Set sample options
loss, split_predictions, lang_stats = eval_utils_mem_ensemble.eval_split(model, crit, loader, opt.training_mode,
    vars(opt))
...
text_file = open('res_ensemble.txt',"aw")
text_file.write('{0}\n'.format(model_paths))
